...
banner
lb
echo "This installer will help you install your Matrix Node to any hard drive partition that has at least 150 GB of free space." | fold -s
lb
...
installType="Do you already have a Matrix node installed on this system?"
lb
PS3="$installType "
